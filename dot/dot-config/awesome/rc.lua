...
beautiful.init("/home/alexs/.config/awesome/theme.lua")
...
awful.screen.connect_for_each_screen(
    function(s)
        ...
        awful.tag({"Main", "Second", "Vivaldi", "Brave",  "5",  "6",  "7",  "Files",  "Torrent"}, s, awful.layout.layouts[1])
...
globalkeys =
    ...
    awful.key({modkey, "Control"}, "]", awful.tag.viewnext, {description = "view next", group = "tag"}),
